 ...
 */
public class VerseNotesContent {

    /**
     * An array of sample (dummy) items.
     */
    public static final List<VerseNotesItem> ITEMS = new ArrayList<VerseNotesItem>();

    /**
     * A map of sample (dummy) items, by ID.
     */
    public static final Map<String, VerseNotesItem> ITEM_MAP =
            new HashMap<String, VerseNotesItem>();
    ...
    private static VerseNotesItem createDummyItem(int position) {
        return new VerseNotesItem(String.valueOf(position), "Item " + position,
    ...
    public static class VerseNotesItem {
        ...
        public VerseNotesItem(String id, String content, String details) {
            this.id = id;
