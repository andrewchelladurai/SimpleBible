...
public abstract class Constants {
    ...
    static final float  VERSE_SIZE_SMALL        = 0.8f;
    static final float  VERSE_SIZE_MEDIUM       = 1.0f;
    static final float  VERSE_SIZE_BIG          = 1.2f;
    static final float  VERSE_SIZE_LARGE        = 1.4f;
    static final String VERSE_STYLE_NORMAL      = "sans-serif";
    static final String VERSE_STYLE_OLD_ENGLISH = "serif";
    static final String VERSE_STYLE_TYPEWRITER  = "monospace";
