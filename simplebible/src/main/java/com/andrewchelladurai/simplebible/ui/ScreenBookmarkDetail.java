...
public class ScreenBookmarkDetail
  ...
  public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container,
    ...
    if (savedState == null) {
      ...
      final ArrayList<EntityVerse> list = new ArrayList<>();
      for (final Parcelable parcelable : parcelableArray) {
        list.add((EntityVerse) parcelable);
      }
  ...
  private void handleClickActionDelete() {
    ...
    final ArrayList<EntityVerse> verseList = model.getCachedList();
  ...
  private void updateContent() {
    final ArrayList<EntityVerse> list = model.getCachedList();
