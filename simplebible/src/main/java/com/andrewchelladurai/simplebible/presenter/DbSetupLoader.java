/*
 *
 * This file 'DbSetupLoader.java' is part of SimpleBible :
 *
 * Copyright (c) 2018.
 *
 ...
 * on 15-Sep-2018 @ 5:05 PM
 */
public class DbSetupLoader
    extends AsyncTaskLoader<Boolean> {

    private static final String TAG = "DbSetupLoader";
    ...
    public DbSetupLoader(final Context context) {
        super(context);
    }
